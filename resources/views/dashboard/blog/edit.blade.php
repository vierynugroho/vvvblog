...
@section('content')
    <div class="my-5">
        <div class="row d-flex justify-content-center">
                    ...
                    <form action="/dashboard/blog/{{ $post->slug }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="title"
                                ...
                                is-invalid
                            @enderror"
                                id="title" placeholder="title" value="{{ old('title', $post->title) }}" autofocus>
                            @error('title')
            ...
            is-invalid                    
                            @enderror"
                                value="{{ old('slug', $post->slug) }}" id="slug" placeholder="slug" name="slug">
                            @error('slug')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            @if ($post->image)
                                <img src="{{ $post->image }}" alt="{{ $post->title }}"
                                    class="img-preview img-fluid mb-3 col-sm-5 rounded-4 d-block">
                            @else
                                <img class="img-preview img-fluid mb-3 col-sm-5 rounded-4" alt="{{ $post->title }}">
                            @endif
                            <input
            ...
            is-invalid                    
                        ...
                        <div class="mb-3">
                            ...
                            <textarea
                                ...
                                is-invalid
                            @enderror"
                                id="body" rows="3" name="body">{{ old('body', $post->body) }}</textarea>
                            @error('body')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>

            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <div class="row d-flex justify-content-between">
                        <div class="col">
                            <a href="/dashboard/blog/create" class="btn btn-danger"><i class="fa-solid fa-plus"></i>
                                Add Post</a>
                        </div>
                    </div>
                </div>
                                ...
                                @foreach ($blogs as $blog)
                                    <tr>
                                        ...
                                        <td class="text-center align-middle">
                                            <a href="/dashboard/blog/{{ $blog->slug }}" class="badge bg-info"><i
                                                    class="fa-solid fa-circle-info text-light"></i></a>
                                            <a href="/dashboard/blog/{{ $blog->slug }}/edit" class="badge bg-warning"><i
